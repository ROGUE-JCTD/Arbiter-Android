...
public class AddLayersLoaderCallbacks implements LoaderManager.LoaderCallbacks<ArrayList<AddLayersListItem>>{
	...
	@Override
	public Loader<ArrayList<AddLayersListItem>> onCreateLoader(int id, Bundle bundle) {
	...
	@Override
	public void onLoadFinished(Loader<ArrayList<AddLayersListItem>> loader, ArrayList<AddLayersListItem> data) {
		if(data == null){
			data = new ArrayList<AddLayersListItem>();
		}
	...
	@Override
	public void onLoaderReset(Loader<ArrayList<AddLayersListItem>> loader) {
